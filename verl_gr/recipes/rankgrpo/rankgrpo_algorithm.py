...
def _compute_rank_grpo_completion_stats(
    *,
    ...
    terminated_lengths = completion_lengths * terminated_with_eos
...
def compute_rank_grpo_training_reward_metrics(data: DataProto) -> dict[str, float]:
    ...
    completion_lengths = data.non_tensor_batch.get("rankgrpo_completion_length")
    terminated_with_eos = data.non_tensor_batch.get("rankgrpo_terminated_with_eos")
    terminated_lengths = data.non_tensor_batch.get("rankgrpo_terminated_length")
    items_detected = data.non_tensor_batch.get("rankgrpo_items_detected")
    overflow_token_counts = data.non_tensor_batch.get("rankgrpo_overflow_token_count")
    if (
