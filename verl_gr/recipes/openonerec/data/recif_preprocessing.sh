...
# Borrowed from https://github.com/Kuaishou-OneRec/OpenOneRec/blob/main/data/onerec_data/run.sh, with modifications
...
RECIF_DIR=/home/dyvm6xra/dyvm6xrauser49/xms-gr/OpenOneRec-RecIF

INPUT_METADATA="${RECIF_DIR}/onerec_bench_release.parquet"
PID2SID_MAPPING="${RECIF_DIR}/video_ad_pid2sid.parquet"
PRODUCT_PID2SID_MAPPING="${RECIF_DIR}/product_pid2sid.parquet"
CAPTION_INPUT="${RECIF_DIR}/pid2caption.parquet"
